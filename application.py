...
def calculate():
    ...
    # example result json : https://maps.googleapis.com/maps/api/distancematrix/json?key=AIzaSyB9ohXdz-pm_rH5JjgyT0w_t6HaKXQTUrU&origins=37.7909,-122.3925&destinations=37.7765,-122.4506&mode=driving&departure_time=now&language=en-EN&sensor=false
